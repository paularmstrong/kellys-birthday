...
export const gifts = [
	{
		img: `${import.meta.env.BASE_URL}img/garmin-backpack-tether.webp`,
	...
	{
		img: `${import.meta.env.BASE_URL}img/garmin-collar-contacts-kit.webp`,
	...
	{
		img: `${import.meta.env.BASE_URL}img/garmin-handheld-screen-protector.webp`,
	...
	{
		img: `${import.meta.env.BASE_URL}img/garmin-tt-25-collar.webp`,
	...
	{
		img: `${import.meta.env.BASE_URL}img/garmin-alpha-300.webp`,
